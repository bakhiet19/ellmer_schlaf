...
export default function QuestionStep({ className }) {
  ...
  return (
    <div
      className={`w-full max-w-xl sm:max-w-2xl lg:max-w-3xl mx-auto px-6 py-12 rounded-xl shadow-lg bg-gradient-to-br from-white via-gray-50 to-gray-100 border border-gray-200 ${className}`}
    >
      {/* Progress Bar */}
