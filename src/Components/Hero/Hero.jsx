    ...
    animationDelay: '0.1s'
      ...
      <div className="flex flex-col justify-around items-center bg-red-500 text-white p-5 sm:p-10 relative overflow-hidden">
        <div className="text-center">
          ...
          <button className="mx-auto block border-2 border-white text-white bg-red-500 font-bold hover:bg-white hover:text-red-500 px-4 sm:px-12 py-2 sm:py-3 rounded-full  transition mb-4 opacity-0 animate-fade-in delay-50 text-sm sm:text-base cursor-pointer">
            Jetzt inserieren
          </button>
        </div>
        ...
        <div className="relative mt-5 w-[200px] sm:w-[300px] h-[200px] sm:h-[300px]">
          ...
          <div className="absolute -top-2 left-1/2 -translate-x-1/2 bg-white text-red-500 px-2 sm:px-3 py-2 sm:py-3 rounded-full text-[10px] sm:text-xs shadow-lg border border-red-500 hidden lg:block bubble-anim" style={{
    animation: 'bubbleFloat 3s ease-in-out infinite',
    animationDelay: '0.3s',
    animationDelay: '0.1s'
  }}>
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -left-20 sm:-left-26 bg-white text-red-500 px-2 sm:px-3 py-2 sm:py-3 rounded-full text-[10px] sm:text-xs shadow-lg border border-red-500 hidden lg:block bubble-anim" style={{
    animation: 'bubbleFloat 3s ease-in-out infinite',
    animationDelay: '0.3s',
    animationDelay: '0.1s'
  }}>
          ...
          <div className="absolute bottom-0 right-0 bg-white text-red-500 px-2 sm:px-3 py-2 sm:py-3 rounded-full text-[10px] sm:text-xs shadow-lg border border-red-500 hidden lg:block bubble-anim" style={{
    animation: 'bubbleFloat 3s ease-in-out infinite',
    animationDelay: '0.3s',
    animationDelay: '0.1s'
  }}>
